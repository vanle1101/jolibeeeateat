...
class SearchOnBing extends Workers_1.Workers {
    ...
    async doSearchOnBing(promotion, page) {
        ...
        try {
            ...
            await page.goto(urls_1.URLs.rewards.dashboard).catch(() => { });
        }
    }
    ...
    async searchBing(page, queries, promotion) {
